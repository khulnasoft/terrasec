...
import (
	...
	"github.com/khulnasoft/terrasec/pkg/notifications/webhook"
	"github.com/khulnasoft/terrasec/pkg/policy/opa"
	"github.com/khulnasoft/terrasec/pkg/vulnerability"

	"go.uber.org/zap"

	"github.com/hashicorp/go-multierror"
	"github.com/khulnasoft/terrasec/pkg/filters"
	iacProvider "github.com/khulnasoft/terrasec/pkg/iac-providers"
	"github.com/khulnasoft/terrasec/pkg/iac-providers/output"
	"github.com/khulnasoft/terrasec/pkg/notifications"
	"github.com/khulnasoft/terrasec/pkg/policy"
	res "github.com/khulnasoft/terrasec/pkg/results"
)
...
func (e *Executor) initPolicyEngines() (err error) {
	...
	for _, policyPath := range e.policyPath {
		...
		if err := engine.Init(policyPath, preloadFilter); err != nil {
			...
			zap.S().Error("perform 'terrasec init' command and then try running the scan command again")
			return err
		}
