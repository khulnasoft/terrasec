...
func TestGetURLSubDir(t *testing.T) {
	...
	table := []struct {
	...
	}{
		{
			...
			URL:        "github.com/khulnasoft/terrasec",
			dest:       someDest,
			wantURL:    "git::https://github.com/khulnasoft/terrasec.git",
			wantSubDir: "",
			wantErr:    nil,
		},
		{
			name:       "github url with subdir",
			URL:        "github.com/khulnasoft/terrasec//some-subdir",
			dest:       someDest,
			wantURL:    "git::https://github.com/khulnasoft/terrasec.git",
		...
		{
			name:       "github ssh url",
			URL:        "git@github.com:khulnasoft/terrasec.git//some-subdir",
			dest:       someDest,
			wantURL:    "git::ssh://git@github.com/khulnasoft/terrasec.git",
			wantSubDir: someSubdir,
			wantErr:    nil,
		},
		{
