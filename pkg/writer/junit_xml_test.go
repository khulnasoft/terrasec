...
<testsuites tests="566" name="TERRASEC_POLICY_SUITES" failures="1" time="0">
  <testsuite tests="566" failures="1" time="0" name="TERRASEC_POLICY_SUITE" package="test">
    <properties>
      <property name="Terrasec Version" value="%s"></property>
    </properties>
...
<testsuites tests="566" name="TERRASEC_POLICY_SUITES" failures="1" time="0">
  <testsuite tests="566" failures="1" time="0" name="TERRASEC_POLICY_SUITE" package="https://github.com/user/repository.git" branch="main">
    <properties>
      <property name="Terrasec Version" value="%s"></property>
    </properties>
  </testsuite>
