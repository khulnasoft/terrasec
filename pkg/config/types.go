...
var global *TerrasecConfig

// TerrasecConfig struct defines global variables/configurations across terrasec
type TerrasecConfig struct {
...
// Notifier represent a single notification in the terrasec config file
type Notifier struct {
	NotifierType   string      `toml:"type" yaml:"type"`
	NotifierConfig interface{} `toml:"config" yaml:"config"`
}

// Rules represents scan and skip rules in the terrasec config file
type Rules struct {
...
// K8sAdmissionControl deny rules in the terrasec config file
