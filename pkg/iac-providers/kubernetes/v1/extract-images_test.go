...
import (
	...
	"github.com/khulnasoft/terrasec/pkg/iac-providers/kubernetes/v1/testdata"
...
func TestK8sV1ExtractContainerImages(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantContainerImageList:     []output.ContainerDetails{{Name: "c", Image: "gcr.io/terrasec/job-wq-1"}},
			wantInitContainerImageList: []output.ContainerDetails{},
		},
		{
