...
type ScanOptions struct {
	...
	// notificationWebhookURL is the URL where terrasec will send the scan report and normalized config json
...
// Scan executes the terrasec scan command
...
// Run executes terrasec in CLI mode
...
// getExitCode returns appropriate exit code for terrasec based on scan output
